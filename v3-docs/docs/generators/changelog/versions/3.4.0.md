...
```bash
meteor update --release 3.4-beta.0
```
...
- accounts-base@3.2.0-beta340.0
- babel-compiler@7.13.0-beta340.0
- boilerplate-generator@2.1.0-beta340.0
- meteor-tool@3.4.0-beta.0
- minifier-js@3.1.0-beta340.0
- rspack@1.0.0-beta340.0
- shell-server@0.7.0-beta340.0
- tools-core@1.0.0-beta340.0
- typescript@5.7.0-beta340.0
