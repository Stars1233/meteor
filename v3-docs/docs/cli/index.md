...
Meteor provides a curated list of community examples that you can use as starting points. The examples are maintained in the [meteor/examples](https://github.com/meteor/examples) repository.
